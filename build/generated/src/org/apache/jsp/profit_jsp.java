...
public final class profit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Profit Calculation</title>\n");
      out.write("        <!-- Bootstrap CSS -->\n");
      out.write("        <link href=\"https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css\" rel=\"stylesheet\">\n");
      out.write("    </head>\n");
      out.write("    <body class=\"bg-light\">\n");
      out.write("        <div class=\"container mt-5\">\n");
      out.write("            <h2 class=\"text-center mb-4 text-dark\">Calculate Product Profit</h2>\n");
      out.write("\n");
      out.write("            <!-- Form to submit product ID -->\n");
      out.write("            <form action=\"\" method=\"POST\" class=\"p-2 bg-white rounded shadow-sm\">\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                    <label for=\"product_id\">Enter Product ID:</label>\n");
      out.write("                    <input type=\"number\" class=\"form-control\" id=\"product_id\" name=\"product_id\" placeholder=\"Enter Product ID\" required>\n");
      out.write("                </div>\n");
      out.write("                <button type=\"submit\" class=\"btn btn-primary btn-block\">Calculate Profit</button>\n");
      out.write("            </form>\n");
      out.write("\n");
